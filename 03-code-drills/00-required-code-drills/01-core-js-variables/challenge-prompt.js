...
var statementOne = fullName + " is a " + nationality + " " + profession + " born in" + " " + birthYear;
...
var statementThree = "In " + yearOfPublish + " the first algorithm, " + firstAlgorithm + " athe the age of " + ageAtYearOfPublish;
...
var statementFour = "She was a " + nationality + " who lived in " + cityLocation + "," + countryLocation + " until her passing at " + deathYear;
